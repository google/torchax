...
def train_one_epoch(weights, buffers, opt_state, epoch_index, tb_writer):
  ...
  for i, data in enumerate(training_loader):
    ...
    loss, weights, opt_state = train_step(weights, buffers, opt_state, inputs, labels)
...
for epoch in range(EPOCHS):
  ...
  avg_loss, weights, opt_state = train_one_epoch(
    weights, buffers, opt_state, epoch_number, writer
  )
  print(avg_loss)
