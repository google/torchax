...
class SharedWeightsTest(base_test_util.TestCase):
  def test_shared_weights(self):
    ...
    jax_weights, jax_func = torchax.extract_jax(model, dedup_parameters=True)

    # Verify that the JAX weights are shared
