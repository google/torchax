...
def diff_output(
  testcase, output1, output2, rtol, atol, equal_nan=True, check_dtype=False
):
  if isinstance(output1, torch.Tensor):
    ...
    for o1, o2 in zip(output1, output2, strict=False):
      diff_output(
        testcase, o1, o2, rtol, atol, equal_nan=equal_nan, check_dtype=check_dtype
      )
  else:
...
class TestCoreAtenOps(unittest.TestCase):
  ...
  def test_aten__adaptive_avg_pool2d_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten._adaptive_avg_pool2d, args, kwargs)
  ...
  def test_aten__adaptive_avg_pool3d_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten._adaptive_avg_pool3d, args, kwargs)
  ...
  def test_aten_bitwise_and_Scalar_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.bitwise_and.Scalar, args, kwargs)
  ...
  def test_aten_bitwise_and_Tensor_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.bitwise_and.Tensor, args, kwargs)
  ...
  def test_aten_bitwise_xor_Scalar_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.bitwise_xor.Scalar, args, kwargs)
  ...
  def test_aten_copy_cast_dtype(self):
    args = (
      torch.randn((10, 10)).to(torch.float32),
      torch.randn((10, 10)).to(torch.int64),
    )
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.copy, args, kwargs)
  ...
  def test_aten_masked_fill_Scalar_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.masked_fill.Scalar, args, kwargs)
  ...
  def test_aten_max_pool2d_with_indices_0(self):
    ...
    kwargs = {}
    run_export_and_compare(
      self, torch.ops.aten.max_pool2d_with_indices, args, kwargs, ignore_indices=True
    )
  ...
  def test_aten_max_pool3d_with_indices_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.max_pool3d_with_indices, args, kwargs)
  ...
  def test_aten_scatter_reduce_two_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.scatter_reduce.two, args, kwargs)
  ...
  def test_aten_transpose_copy_int_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.transpose_copy.int, args, kwargs)
  ...
  def test_aten_upsample_bilinear2d_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.upsample_bilinear2d, args, kwargs)
  ...
  def test_aten_upsample_nearest2d_0(self):
    ...
    kwargs = {}
    run_export_and_compare(self, torch.ops.aten.upsample_nearest2d, args, kwargs)
  ...
  def test_aten_rand_like(self):
    ...
    kwargs = {}
    run_export_and_compare(
      self, torch.ops.aten.rand_like, args, kwargs, atol=math.inf, check_dtype=True
    )
  ...
  def test_einsum(self):
    ...
    kwargs = {}
    run_export_and_compare(
      self, torch.einsum, args, kwargs, atol=1e-2, rtol=1e-2, check_dtype=True
    )
  ...
  def test_aten_einsum(self):
    ...
    kwargs = {}
    run_export_and_compare(
      self, torch.ops.aten.einsum, args, kwargs, atol=1e-2, rtol=1e-2, check_dtype=True
    )
  ...
  def test_aten_linear(self):
    ...
    kwargs = {}
    run_export_and_compare(
      self, torch.ops.aten.linear, args, kwargs, atol=1e-2, rtol=1e-2, check_dtype=True
    )
