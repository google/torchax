...
class UnboundedDynamismExportTest(unittest.TestCase):
  ...
  def test_add_scalar(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"tensor<\?x197x768xf32>.*->.*tensor<\?x197x768xf32>", shlo_text)
      is not None
    )
  ...
  def test_addmm(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"tensor<\?x5xf32>.*->.*tensor<\?x5xf32>", shlo_text) is not None
    )
  ...
  def test_cat(self):
    ...
    dynamic_shapes = (({0: Dim("dim")}, {0: Dim("dim")}),)
    m = wrap_func_as_nn_module(lambda x, y: torch.ops.aten.cat.default([x, y], 1))
    ep = export(m, args=args, dynamic_shapes=dynamic_shapes)
    shlo_module = exported_program_to_stablehlo(ep)
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
  ...
  def test_conv(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"tensor<\?x3x224x224xf32>.*->.*tensor<\?x5x14x14xf32>", shlo_text)
      is not None
    )
  ...
  def test_conv1d(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"tensor<\?x1x800xf32>.*->.*tensor<\?x512x159xf32>", shlo_text)
      is not None
    )
  ...
  def test_div_scalar(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"tensor<\?x12x197xf32>.*->.*tensor<\?x12x197xf32>", shlo_text)
      is not None
    )
  ...
  def test_embedding(self):
    ...
    args = (torch.rand((20, 768)), torch.randint(0, 15, (3, 10)).to(torch.int64))
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x10xi64>.*->.*tensor<\?x10x768xf32>", shlo_text)
      is not None
    )
  ...
  def test_mean(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x197x768xf32>.*->.*tensor<\?x197x1xf32>", shlo_text)
      is not None
    )
  ...
  def test_ne_scalar(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x5xi64>.*->.*tensor<\?x5xi32>", shlo_text) is not None
    )
  ...
  def test_native_group_norm(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x512x159xf32>.*->.*tensor<\?x512x159xf32>", shlo_text)
      is not None
    )
  ...
  def test_native_layer_norm(self):
    class M(torch.nn.Module):
      def forward(self, x, weight, bias):
        return torch.ops.aten.native_layer_norm.default(x, [768], weight, bias, 1e-12)[
          0
        ]
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x197x768xf32>.*->.*tensor<\?x197x768xf32>", shlo_text)
      is not None
    )
  ...
  def test_permute(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<\?x197x12x64xf32>.*->.*tensor<\?x12x197x64xf32>", shlo_text
      )
      is not None
    )
  ...
  def test_select(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x197x768xf32>.*->.*tensor<\?x768xf32>", shlo_text)
      is not None
    )
  ...
  def test_slice(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<\?x3x224x224xf32>.*->.*tensor<\?x3x224x224xf32>", shlo_text
      )
      is not None
    )
  ...
  def test_slice_2(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<\?x3x224x224xf32>.*->.*tensor<\?x2x224x224xf32>", shlo_text
      )
      is not None
    )
  ...
  def test_softmax(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<\?x12x197x197xf32>.*->.*tensor<\?x12x197x197xf32>", shlo_text
      )
      is not None
    )
  ...
  def test_softmax_reduce_on_dynamic_dim(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<1x8x128x\?xf32>.*->.*tensor<1x8x128x\?xf32>", shlo_text)
      is not None
    )
  ...
  def test_sub_scalar(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"tensor<\?x1x1x10xf32>.*->.*tensor<\?x1x1x10xf32>", shlo_text)
      is not None
    )
  ...
  def test_transpose_on_dynamic_dim(self):
    ...
    m = wrap_func_as_nn_module(lambda x: torch.ops.aten.transpose.int(x, -2, -1))
    ep = export(m, args=args, dynamic_shapes=dynamic_shapes)
    shlo_module = exported_program_to_stablehlo(ep)
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<1x8x\?x256xf32>.*->.*tensor<1x8x256x\?xf32>", shlo_text)
      is not None
    )
  ...
  def test_unsqueeze_1(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<\?x10xf32>.*->.*tensor<\?x1x10xf32>", shlo_text)
      is not None
    )
  ...
  def test_unsqueeze_2(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<1x1x\?x256xf32>.*->.*tensor<1x1x1x\?x256xf32>", shlo_text
      )
      is not None
    )
  ...
  def test_dynamic_view(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<\?x3x224x224xf32>.*->.*tensor<\?x5x43681xf32>", shlo_text
      )
      is not None
    )
  ...
  def test_dynamic_view_non_bs(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<1x\?x2x16xf32>.*->.*tensor<1x\?x16xf32>", shlo_text)
      is not None
    )
  ...
  def test_dynamic_expand(self):
    ...
    shlo_text = shlo_module.get_stablehlo_text()
    self.assertTrue(
      re.search(r"%arg.: tensor<1x1x768xf32>.*->.*tensor<\?x1x768xf32>", shlo_text)
      is not None
    )
  ...
  def test_dynamic_expand_2(self):
    ...
    self.assertTrue(
      re.search(
        r"%arg.: tensor<1x1x1x\?x256xf32>.*->.*tensor<1x1x8x\?x256xf32>", shlo_text
      )
      is not None
    )
